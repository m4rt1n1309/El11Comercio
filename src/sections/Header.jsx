...
export const Header = () => {
  return (
    <>
      <div className="w-screen h-[calc(100vh-7rem)]">
        <div className="bg-cover bg-[url('/public/pluma.webp')] bg-center bg-no-repeat h-full w-full">
          <div className="container mx-auto flex flex-col my-auto align-middle h-full">
            <div className="my-auto  mx-auto lg:mx-0 w-10/12 lg:w-2/5">
              <h1 className="text-7xl mb-4">
                <span className="text-violet-500">Let’s talk</span> about your
                next trip!
              </h1>
