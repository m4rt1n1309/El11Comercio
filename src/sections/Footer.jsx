      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden bg-black">
        ...
        >
          <path
            ...
            className="relative block fill-black fill-white"
          ></path>
        </svg>
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1  gap-20 p-20 text-[18px] font-mono">
          <div className="flex flex-col">
            ...
            <p>
              ...
              quam delectus, itaque, quisquam eligendi laborum nam laboriosam.
            </p>
          </div>
          <div className="flex flex-col">
            <ul>
          ...
          <div className="flex flex-col">
            <ul>
              <li className="text-[22px] list-none font-semibold text-pink-500 py-2 uppercase mb-4">
                Creativity
              </li>
              <li className="my-4 list-none">Website Guidline Ideas</li>
              <li className="my-4 list-none">Tips y Tricks</li>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              <a
                className="text-white hover: text-pink-500 transition-all duration-150 ease-in-out transform hover:scale-150"
                href=""
              >
                <FaGithub />
              </a>
        ...
        <div className="h-full flex items-center justify-center mb-5">
          <form className="w-96 relative" action="">
            <input
              className="w-full text-gray-800 p-4 h-10 rounded-full focus:outline-none focus:border-pink-800"
              type="email"
            />
            <button
              className="bg-pink-400 px-8 py-2 rounded-full text-white absolute top-0 right-0"
              type="submit"
            >
              Submit
            </button>
